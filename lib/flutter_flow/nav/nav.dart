...
const debugRouteLinkMap = {
  ...
  '/homepage':
      'https://app.flutterflow.io/project/brighton-spot-3t7pm2?tab=uiBuilder&page=Homepage',
  '/aLLEVENTjulyDec':
      'https://app.flutterflow.io/project/brighton-spot-3t7pm2?tab=uiBuilder&page=ALLEVENTjuly-Dec',
  '/allVenues':
  ...
  '/shareSpot':
      'https://app.flutterflow.io/project/brighton-spot-3t7pm2?tab=uiBuilder&page=shareSpot',
  '/spotscreen':
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'ALLEVENTjuly-Dec',
          path: '/aLLEVENTjulyDec',
          builder: (context, params) => ALLEVENTjulyDecWidget(),
        ),
        FFRoute(
          name: 'AllVenues',
          path: '/allVenues',
          builder: (context, params) => AllVenuesWidget(),
        ),
        FFRoute(
          name: 'January',
          path: '/january',
          builder: (context, params) => JanuaryWidget(
        ...
        FFRoute(
          name: 'pROMOTERS',
          path: '/pROMOTERS',
          builder: (context, params) => PROMOTERSWidget(),
        ),
        FFRoute(
          name: 'Promoterdetails',
          path: '/promoterdetails',
          builder: (context, params) => PromoterdetailsWidget(
            promoters: params.getParam(
              'promoters',
              ParamType.JSON,
            ),
          ),
        ...
        FFRoute(
          name: 'Alleve6mthCopy',
          path: '/alleve6mthCopy',
          builder: (context, params) => Alleve6mthCopyWidget(),
        ),
        FFRoute(
          name: 'homePageDemo',
          path: '/homePageDemo',
        ...
        FFRoute(
          name: 'shareSpot',
          path: '/shareSpot',
          builder: (context, params) => ShareSpotWidget(),
        ),
        FFRoute(
          name: 'spotscreen',
          path: '/spotscreen',
          builder: (context, params) => SpotscreenWidget(),
        ),
        FFRoute(
          name: 'webviewPage',
          path: '/webviewPage',
          builder: (context, params) => WebviewPageWidget(
            viewUrl: params.getParam(
              'viewUrl',
              ParamType.String,
            ),
          ),
        ...
        FFRoute(
          ...
          builder: (context, params) => SendVerificationEmailWidget(),
        ),
        FFRoute(
          name: 'addEvents',
          path: '/addEvents',
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/logo11-removebg-preview.png',
                    fit: BoxFit.cover,
                  ),
                )
              : page;
